...
import { TableTypeEvent } from '../components/Tables/TableTypeEvent'
import Swal from 'sweetalert2'

export const ViewTypeEvents = () => {
        ...
        try {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const { data } = await axios.delete(`http://localhost:3200/eventType/delete/${id}`);
                    getTableEventTpes();
                    Swal.fire(
                        data.message,
                        '',
            ...
            <nav className="navbar navbar-expand-lg navbar-light" style={{ background: "#9dc19d" }}>
                <div className="container-fluid">
                    <div className="collapse navbar-collapse justify-content-center" id="navbarCenteredExample" >
                        <h1 className='text-white' style={{ fontSize: "2.5rem" }}>VIEW TYPE_EVENTS</h1>
                    </div>
                </div>
            </nav>
            <br />
                                                                        ...
                                                                        <td className="text-center align-middle">
                                                                            <div className="btn-group align-top">
                                                                                <div className="btn btn-sm btn-primary btn-outline-secondary badge">
                                                                                    <button onClick={() => navigate(`/profile/updateTypeEvent/${_id}`)} className="btn badge" type="button" data-toggle="modal" data-target="#user-form-modal">
                                                                                ...
                                                                                <div className="btn btn-sm btn-danger btn-outline-secondary badge">
                                                                                    <button onClick={() => deleteTypeRoom(_id)} className="btn badge" type="button">
